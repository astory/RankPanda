...
class FMCustomizeDlg(wx.Dialog):
    """
    Class used to customize the appearance of FlatMenu, FlatMenuBar and
    FlatToolbar.
    """
    ...
    def CreateDialog(self):
        ...
        self._book.SetColour(INB_TAB_AREA_BACKGROUND_COLOR, ArtManager.Get().GetMenuFaceColour())
...
##        colorChoices = [_("Default"), _("Generic"), _("Dark"), _("Dark Olive Green")]
        ...
        self._colour = wx.ComboBox(options, self._colourID, ArtManager.Get().GetMenuBarColourScheme(), choices=colorChoices,
